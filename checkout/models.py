...
class Order(models.Model):
    ...
    postcode_eircode = models.CharField(max_length=20, null=True, blank=True)
...
class OrderLineItem(models.Model):
    ...
    lineitem_discount_total = models.DecimalField(max_digits=6, decimal_places=2, null=False, blank=False, editable=False)
    ...
    def save(self, *args, **kwargs):
        ...
        """
        self.lineitem_total = (self.product.price - self.product.price * (self.product.discount/100)) * self.quantity
